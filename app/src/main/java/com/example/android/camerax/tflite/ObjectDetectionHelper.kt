...
class ObjectDetectionHelper(private val tflite: Interpreter, private val labels: List<String>) {
    ...
    private val scale13 = arrayOf(Array(13){Array(13){FloatArray(36)} })
    private val scale26 = arrayOf(Array(26){Array(26){FloatArray(36)} })
    private val scale52 = arrayOf(Array(52){Array(52){FloatArray(36)} })
...
//    )
    ...
    fun getFinalBox(imageSize: Size){
